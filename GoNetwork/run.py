...
if __name__ == '__main__':
    ...
    parser.add_argument('--workers', type=int, default=12, help='number of data loading workers (default: 4)')
    parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
    parser.add_argument('--print_frequency', type=int, default=200, help='print frequency (default: 50)')
